     ...
     function insert(){ // this function will insert the value to the game
            ...
            for(let i=0;i<ul.length;i++){
                    ...
                    ul[i].addEventListener("click",function(){
                            ...
                            if(ul[i].innerHTML == ""){
                                    ...
                                    if(num % 2 == 0){ // if num is EVEN it will return X value
                                        ul[i].innerHTML = "X";
                                    ...
                                    else // if num is ODD it will return O value
                                    {
                                        ul[i].innerHTML = "O";
      ...
      function selectWinner(){ // This function will pick winner 
